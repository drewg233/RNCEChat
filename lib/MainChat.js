...
class MainChat extends Component {
	...
	constructor(props) {
		...
		console.log('publishKey: ', this.props.publishKey);
		console.log('subscribeKey: ', this.props.subscribeKey);
	}
	...
	componentDidMount() {
		...
		console.log('chatRoomName: ', this.props.chatRoomName);

		ChatEngine.on('$.ready', data => {
			const me = data.me;
			let chat = new ChatEngine.Chat('chatengine-demo-chat');
